...
#define CV_WHITE_2 cvScalar(255,255,255,0)
#define CV_BLACK_2 cvScalar(0,0,0,0)
#define CV_YELLOW_2 cvScalar(0,255,255,0)
#define CV_BLUE_2 cvScalar(255,0,0,0)
#define CV_BROWN_2 cvScalar(0,63,127,0)
#define CV_PINK_2 cvScalar(255,170,255,0)
...
private:
    ...
    void draw_result_lines(CvMat *lines_mat, IplImage* image, CvScalar color = CV_RED_2, int thickness = 2);
